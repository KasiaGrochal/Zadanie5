...
public class Producent {
    ...
    public ProducentName getProducentName(Model model){
        switch (model){
            case Yaris: case Avensis: case Corolla: setProducentName(ProducentName.TOYOTA);
            break;
            case X3: case i4M50: case Z4Roadster: setProducentName(ProducentName.BMW);
            break;
            case A3: case A6: setProducentName(ProducentName.AUDI);
            break;
            case S60: case C30: setProducentName(ProducentName.VOLVO);
            break;
        }
